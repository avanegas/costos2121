    ...
    @if ($grupo_materials->count())
        <div class="card-body">
            <table class="table table-striped">
                ...
                <tbody>
                @foreach($grupo_materials as $grupo)
                    <tr>
                        <td>{{$grupo->id}}</td>
                        ...
                        <td style="width:10px">
                            <a href="{{route('admin.grupo_materials.edit', $grupo)}}"><i class="fa fa-edit"></i></a>
                        </td>
                        <td style="width:10px">
                            <form action="{{route('admin.grupo_materials.destroy', $grupo)}}" method="POST">
                                @csrf
                                @method('DELETE')
